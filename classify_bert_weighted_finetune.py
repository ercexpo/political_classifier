...
tokenizer = BertTokenizer.from_pretrained('models/finetune')
...
model = BertForSequenceClassification.from_pretrained(
    'models/finetune', # Use multilingual pretrained model.
...
for epoch_i in range(0, epochs):
    ...
    for step, batch in enumerate(train_dataloader):
        ...
        loss = loss_func(logits.view(-1,num_labels),b_labels.type_as(logits).long())
