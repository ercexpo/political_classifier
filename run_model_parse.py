...
import load_data_run_parse as load_data
...
model = BertForSequenceClassification.from_pretrained('/app/communications/political/bert_classifier/models/multilingual_test')
#config = BertConfig.from_json_file('../models/bert_classifier_2epoch_256size/config.json')
tokenizer = BertTokenizer.from_pretrained('/app/communications/political/bert_classifier/models/multilingual_test')
